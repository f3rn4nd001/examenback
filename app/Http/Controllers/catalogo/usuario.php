...
class usuario extends Controller
{
    ...
    public function postRegistro(Request $request){
        ...
        try {
            ...
            $tPuesto = (isset($result['tPuesto'])&&$result['tPuesto']!="" ? "'".(trim($result['tPuesto']))."'":   "NULL");
            $nSarario = (isset($result['nSarario'])&&$result['nSarario']!="" ? "'".(trim($result['nSarario']))."'":   "NULL");
            $EcodEstatus = 1;
            ...
            if ($ecodUsuarios == 'NULL') {
                $insert=" CALL `stpInsertarUsuario`(".$tRFC.",".$tNombre.",".$tApellido.",".$EcodEstatus.",".$uuid2.",".$loginEcodUsuarios.",".$tPuesto.",".$nSarario.")";
                $response = DB::select($insert);
            }
            else {
                $insert=" CALL `stpInsertarUsuario`(".$tRFC.",".$tNombre.",".$tApellido.",".$EcodEstatus.",".$ecodUsuarios.",".$loginEcodUsuarios.",".$tPuesto.",".$nSarario .")";
                $response = DB::select($insert);
            }
    ...
    public function getRegistro(Request $request){
        $select="SELECT cu.nSarario, cu.tPuesto, cu.ecodUsuarios,cu.trfc,cu.fCreacion, ce.tNombre AS estatus, concat_ws('',cu.tNombre,' ',cu.tApellido) AS nombres  FROM catusuarios cu
